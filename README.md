<div align="center">
  ...
  <h3 align="center">Picha Print</h3>
</div>
...
Create your own style with our new 3D Customization App. Pick colors, add logos, and try AI designs to make your virtual swag unique. Built using React.js, Three.js, and OpenAI to show the usage of a 3D world with AI
...
👉 **3D Swag Generation**: Generate unique 3D models from your images

👉 **Color Customization**: Apply any color to the 3D shirt/swag for personalized styling.

👉 **Logo Upload Functionality**: Enable users to upload any file, integrating it seamlessly onto the 3D.

👉 **Texture Image Upload**: Allow users to upload texture images to style the 3D

👉 **AI-Generated Logo Integration**: Utilize AI to generate logos and intelligently apply them to the 3D
